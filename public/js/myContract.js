    ...
    $.ajax({
        ...
        success: function (jsonData) {
            if (jsonData.code == "0") {
                ...
                $("span[name=rentMoney]").html(data.rent);
                $("span[name=rentType]").html(data.rentPayTypeStr);
                $("span[name=deposit]").html(data.deposit);
                $("span[name=payPeriods]").html(data.payPeriods);
                ...
                var addr =  landlordHouse.areaName + "-" + landlordHouse.roomAddress;
